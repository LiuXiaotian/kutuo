...
namespace WarOfLords.Common
{
    ...
    {
        public ConcurrentDictionary<string, string> CountryFederationMapDic = new ConcurrentDictionary<string, string>();
        public ConcurrentDictionary<string, List<BattleTeam>> CountryBattleTeamsMapDic = new ConcurrentDictionary<string, List<BattleTeam>>();
        public ConcurrentDictionary<string, CountryMessageQueue> CountryMessageQueueMapDic = new ConcurrentDictionary<string, CountryMessageQueue>();
    }
